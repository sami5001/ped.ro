...
<Image src={microlink}>
  A screen shot of Microlink Cards showing [my template](https://cards.microlink.io/editor?preset=pedro)
</Image>

## Building my template

Instead of using an existing template, I decided to build my own. Templates are built (designed) in JSX, powered by [Theme UI](https://theme-ui.com). What a good idea! 👏
